                ...
                <div class="flex gap-4">
                    <div class="w-64">
                        <div class="border border-gray-100 shadow">
                            <div class="p-2 text-gray-500 bg-gray-200 ">
                                フォルダ
                            </div>
                            <div class="border-b border-inherit p-2 bg-white">
                                <button class="px-2 py-1 border bg-gray-50 border-inherit text-gray-500 hover:bg-gray-100 w-full">フォルダを追加</button>
                            </div>
                            <div class="flex flex-col bg-white divide-y divide-inherit">
